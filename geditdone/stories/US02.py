        ...
        for family in families.values():
            if individual.birth is not None and \
                ...
                individual.birth >= family.married:
                    errorMessage = f'Individual {individual.id} birth date {individual.birth} occurs after marriage date {family.married}'
                ...
                # TODO talk about this logic, not sure it makes sense
                    errorMessage = f'Individual {individual.id} does not have a birth date before marriage date {family.married}'
                    errors.append(GedcomError(GedcomError.ErrorType.error, 'US02', family, errorMessage))
